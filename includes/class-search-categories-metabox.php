...
class Search_Categories_Metabox {
	...
	public function load_admin_styles() {
		...
		wp_enqueue_style( 'scm_admin_post_editor_css', plugin_dir_url( $this->plugin_file ) . 'assets/css/search-categories-metabox-wp-editor.css', false, $this->plugin_version );
